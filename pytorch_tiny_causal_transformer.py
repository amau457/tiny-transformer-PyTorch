...
text = (
    "Bonjour! Ceci est un tout petit dataset d'exemple pour entraîner un tiny LLM. "
    "Je suis ton père."
) * 200  # augmentation (overfit but we have to with this size of ds)
